...
func TestPostprocessMarkdownEscapesARIInCodeBlock(t *testing.T) {
	...
	want := "before\n\n<div><pre><code class=\"language-terraform\">resource = &#34;ari:<span>cloud</span>:jira::site/example&#34;\n</code></pre></div>\n\nafter\n"
	if got != want {
...
func TestPostprocessMarkdownEscapesInlineARIs(t *testing.T) {
	...
	want := "Use <samp>ari:<span>cloud</span>:</samp> or <samp>ari:<span>cloud</span>:jira::site/&lt;site-id&gt;</samp>.\n"
